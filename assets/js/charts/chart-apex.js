...
$(function () {
  ...
  var barChartEl = document.querySelector('#bar-chart'),
    barChartConfig = {
      ...
      xaxis: {
        categories: ['IT in Business', 'Islamic<br>Studies', 'Management<br>Principles', 'Oral Communication<br>and Presentation Skills', 'Personal Management<br>and Communication']
      },
      yaxis: {
        opposite: isRtl
      }
